                  ...
                  <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                    <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                      ...
                      <p className="leading-relaxed">
                        Enter your mobile number, a 6-digit OTP Code will be
                        sent to your mobile number via text. Enter the 6-digit
                        code received.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex relative pb-6 sm:items-center md:w-2/3 mx-auto">
                  ...
                  <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                    <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                      ...
                      <p className="leading-relaxed">
                        If you haven't registered before by clicking on
                        "Profile" and enter all required details.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                  ...
                  <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                    <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                      ...
                      <p className="leading-relaxed">
                        Click on "Product Lease Program”, Request a PLP, Fill
                        the PLP Form and Submit.
                      </p>
                    </div>
                  </div>
                </div>
