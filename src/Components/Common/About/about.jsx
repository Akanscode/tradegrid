...
const About = () => {
  ...
  return (
    <div>
      <div className="relative bg-white w-full h-[910px] ">
        <div className="carousel relative container mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl px-6 top-[100px] md:top-[200px] md:px-8 lg:px-10">
            ...
            >
              {data.map((resource, index) => {
                return (
                  <div
                    key={index}
                    className="carousel-item text-center relative min-w-full min-h-full md:h-[400px] w-[1236px] flex md:flex-row flex-col-reverse flex-grow-0 items-center justify-between gap-4 snap-start"
                  >
                    ...
                    <div className=" md:h-[300px] h-auto w-full md:w-[50%] aspect-square block">
                      <img
                        src={resource.cover}
                        alt={resource.title}
