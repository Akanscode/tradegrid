...
const Abouttradegrid = () => {
  return (
    <div>
      <div className="bg-[#0E1F33] w-full min-h-screen">
        <div className="container mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl px-6 py-20 md:px-8 lg:px-40">
          <div className="flex flex-col md:mx-auto  xl:mx-40 ">
            <div className="bg-white py-20 md:py-40 rounded-xl flex items-center justify-center justify-items-center shadow-md  h-[326.21px] w-auto sm:w-[500px] md:h-[442px] md:w-[700px]">
            ...
            <div className="pt-10">
              ...
              <p className="text-[#FFFFFF] text-sm max-w-lg py-6 leading-5">
                ...
                operations in a growing number of countries across the globe. In
                each of these countries, we partner with more than 80% of the
                leading product marketers, refineries, and mid-stream players,
                to deliver exceptional buying experiences through our digital
                platform.
              </p>
              <p className="text-[#FFFFFF] text-sm max-w-lg leading-5">
                ...
                an ultimate aim of enhancing the TradeGrid Buyers benefits and
                experience.
              </p>
              <Link
                to="/about"
