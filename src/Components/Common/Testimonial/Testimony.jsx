...
const Testimony = () => {
  ...
  return (
    <div className="bg-[#FFFFFF] w-full h-[1790px] md:h-[1161px] ">
      <div className="container mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl px-6 top-[100px]  md:px-8 lg:px-10">
