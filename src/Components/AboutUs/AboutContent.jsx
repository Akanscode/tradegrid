...
import { shutterstockimg } from "../data";
          ...
          <div className="px-0 md:px-16 py-32">
            <div className="flex flex-col items-center justify-center pt-32 ">
              ...
              <p className="max-w-md font-medium text-center text-black text-[0.98rem]">
                Our 5 major product offerings lie along the end-to-end value
                chain of a deal execution pipeline, from Deal Sourcing, to
                Financing and Trade Logistics.
              </p>
            </div>
                              ...
                              <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                                ...
                                <div>
                                  ...
                                  <p className="mb-3 text-sm text-gray-900">
                                    ...
                                    unrivalled digital eco-system which
                                    ultimately delivers increased levels of
                                    commercial activity to users. Learn How…
                                    (link to TradeGrid Ninja™- for sellers).
                                  </p>
                                  <Link
                              ...
                              <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                                ...
                                <div>
                                  ...
                                  <p className="mb-3 text-sm text-gray-900">
                                    ...
                                    – The Integrated Autonomous Bidding Agent
                                    (ABA) - allowing Sellers participate in an
                                    almost infinite number of simultaneous bids
                                    at lightning speed - and The Quote Broadcast
                                    & Rank (QBR) technology - a multivariate bid
                                    processing technology with capacity to
                                    request and process thousands of bids per
                                    second.
                                  </p>
                                  <Link
                                    to="/src/Components/SellerAndBuyer/SellerHeader.jsx"
                            ...
                            <div className="flex flex-col gap-8 mx-auto pt-8">
                              <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                                ...
                                <div>
                                  ...
                                  <p className="mb-3 text-sm text-gray-900">
                                    While our platforms are built to be
                                    extremely user-friendly, we have developed a
                                    straight-forward verification protocol to
                                    ensure all verified users are traceable,
                                    authentic and with the right level of
                                    product liability insurance. This allows
                                    transacting parties on the platform carry on
                                    without risk of potential fraud.
                                  </p>
                                </div>
                              </div>
                              <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                      ...
                      >
                        <div className="flex flex-col md:flex-row justify-between gap-8">
                          <div className="flex flex-col pt-6">
                            ...
                            <p className="text-[#190D2D] text-sm max-w-md">
                              TG Finance™ provides financial support products
                              such as Secure escrow payment services, Trade
                              loans, Supply Chain Financing.
                            </p>
                            <div className="flex flex-col gap-8 mx-auto pt-8">
                              <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                                <div className="mr-4">
                                ...
                                <div>
                                  ...
                                  <p className="mb-3 text-sm text-gray-900">
                                    TradeGrid partners with top banks and
                                    lenders, both locally and internationally to
                                    provide financing for deals authenticated by
                                    the platform, while providing a digital
                                    escrow service, enabling users transact
                              ...
                              <div className="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                                ...
                                <div>
                                  ...
                                  <p className="mb-3 text-sm text-gray-900">
                                    ...
                                    eco-system of vetted vessel owners, tank
                                    farm operators and truckers, exploiting the
                                    Milk Run and the Sharing economies model to
                                    reduce overall transport cost for users.
                                  </p>
                                </div>
                              </div>
                            </div>
